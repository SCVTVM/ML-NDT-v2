...
iscrack = layers.Dense(1, activation='sigmoid', name='binary_output')(cb)
...
model.compile(
    ...
    loss_weights={
        ...
        'regression_output': 2.0  # Higher weight for regression to emphasize it more
    },
    metrics={'binary_output': ['acc'],
